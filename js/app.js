...
(function (document) {
    ...
    TableView = React.createClass({displayName: "TableView",
        /*
        ...
        render: function () {
            var rows = this.state.table.map(function (row, index) {
                return (React.createElement("tr", {key: JSON.stringify(row), className: "table--league__body__row"}, 
                    React.createElement("td", {className: "table--league__body__row__cell table--league__body__row__cell--position"}, index + 1), 
                    React.createElement("td", {className: "table--league__body__row__cell table--league__body__row__cell--name"}, row.name), 
                    React.createElement("td", {className: "table--league__body__row__cell table--league__body__row__cell--played"}, row.played), 
                    React.createElement("td", {className: "table--league__body__row__cell table--league__body__row__cell--points"}, row.points), 
                    React.createElement("td", {className: "table--league__body__row__cell table--league__body__row__cell--goals-f"}, row.goalsScored), 
                    React.createElement("td", {className: "table--league__body__row__cell table--league__body__row__cell--goals-a"}, row.goalsConceded), 
                    React.createElement("td", {className: "table--league__body__row__cell table--league__body__row__cell--goals-d"}, row.goalsDiff)
                ));
            });

            return (React.createElement("table", {className: "table--league"}, 
                React.createElement("thead", {className: "table--league__header"}, 
                    React.createElement("tr", {className: "table--league__header__row"}, 
                        React.createElement("th", {className: "table--league__header__row__cell"}, "#"), 
                        React.createElement("th", {className: "table--league__header__row__cell"}, "Name"), 
                        React.createElement("th", {className: "table--league__header__row__cell"}, "P"), 
                        React.createElement("th", {className: "table--league__header__row__cell"}, "Pts"), 
                        React.createElement("th", {className: "table--league__header__row__cell"}, "F"), 
                        React.createElement("th", {className: "table--league__header__row__cell"}, "A"), 
                        React.createElement("th", {className: "table--league__header__row__cell"}, "GD")
                    )
                ), 
                React.createElement("tbody", {className: "table--league__body"}, rows)
            ));
        }
    });

    React.render(React.createElement(TableView, null), document.getElementById('app'));
})(window.document);

},{"../node_modules/react/addons":5,"./ajax":1,"./gamesservice":2}],4:[function(require,module,exports){
...
},{"./emptyFunction":134,"_process":4}]},{},[1,2,3]);
